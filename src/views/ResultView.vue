...
const deepInsightPeriods = computed(() => {
  return deepInsight.value?.periods?.filter(period => period.notes && period.notes.length > 0) ?? []
})
const hasLegacyDeepInsight = computed(() => Boolean(deepInsight.value && !deepInsight.value.periods && deepInsight.value.groups))
        ...
        <div class="space-y-3">
          ...
          <GlassCard class="p-5 h-full flex flex-col justify-between bg-slate-900/30">
            ...
            <div class="mt-4 pt-4 border-t border-slate-800">
              ...
              <div v-if="deepInsightPeriods.length" class="space-y-3">
                ...
                <div class="space-y-2">
                  <div
                    v-for="period in deepInsightPeriods"
                    :key="period.key"
              ...
              <p v-else-if="hasLegacyDeepInsight" class="text-xs text-slate-500 italic leading-relaxed">
